...
function questionsById(req, res) {
    pool.getConnection((err, connection) => {
        ...
        connection.query(`SELECT test_has_questions.question_id, questions.* from questions LEFT JOIN test_has_questions on test_has_questions.question_id = questions.id where test_has_questions.test_id = ?`, `${req.params.id}`, (err, rows) => {
